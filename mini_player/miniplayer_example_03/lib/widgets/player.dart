    ...
    return Miniplayer(
      ...
      builder: (height, percentage) {
        ...
        final percentageMiniplayer =
            percentageFromValueInRange(min: playerMinHeight, max: playerMaxHeight * miniplayerPercentageDeclaration + playerMinHeight, value: height);
                    ...
                    child: Padding(
                      ...
                      child: Opacity(
                        ...
                        child: Column(
                          ...
                          children: [
                            Text(audioObject.title, style: Theme.of(context).textTheme.bodyText2!.copyWith(fontSize: 16)),
                            Text(
